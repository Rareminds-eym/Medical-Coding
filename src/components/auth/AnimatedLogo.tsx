        ...
        <>
          <div className="flex flex-row items-center justify-center w-full space-x-6">
            ...
            <div className="flex items-center justify-center mt-4">
              <img src="/logos/nmlogo.png" alt="NM Logo" className="h-24 w-32 object-contain drop-shadow-lg bg-white p-1  rounded-md border-2 border-blue-200" />
            </div>
            {/* Main Logo Container */}
            ...
            {/* Right Logo */}
             ...
             <div className="flex items-center justify-center mt-4">
              <img src="/logos/RareMinds.png" alt="RareMinds Logo" className="h-24 w-32 object-contain drop-shadow-lg bg-white  p-1 rounded-md border-2 border-blue-200" />
            </div>
          </div>
          {/* Animated Title */}
