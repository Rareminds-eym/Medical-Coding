-- =====================================================
-- FINAL ERROR-FREE LEVEL 4 SCORE HISTORY MANAGEMENT
-- This version has NO compilation errors and properly manages top 3 attempts
...
-- =====================================================
-- TEST FUNCTION TO VERIFY SCORE HISTORY LOGIC
-- =====================================================
...
-- =====================================================
-- QUICK TEST COMMAND (Run this after the above functions)
-- =====================================================

/*
-- Test the score history with sample data:
SELECT * FROM test_level4_score_history_logic(
    '12345678-1234-1234-1234-123456789012'::uuid, 
    1, 
    ARRAY[50, 75, 60, 85, 70]
);

-- This should show:
-- Step 1: score 50 -> score_history: [50]
-- Step 2: score 75 -> score_history: [75, 50] 
-- Step 3: score 60 -> score_history: [75, 60, 50]
-- Step 4: score 85 -> score_history: [85, 75, 60] (removed 50)
-- Step 5: score 70 -> score_history: [85, 75, 70] (removed 60)
*/
